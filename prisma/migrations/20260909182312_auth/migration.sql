...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'LOGIN', 'LOGOUT', 'CHECK_IN', 'CHECK_OUT', 'LEAVE_APPROVE', 'LEAVE_REJECT');
...
CREATE TABLE "attendances" (
    ...
    "earlyLeaveMins" INTEGER NOT NULL DEFAULT 0,
    "checkInIp" TEXT,
    "checkOutIp" TEXT,
    "notes" TEXT,
...
-- AddForeignKey
ALTER TABLE "employee_profiles" ADD CONSTRAINT "employee_profiles_workScheduleId_fkey" FOREIGN KEY ("workScheduleId") REFERENCES "work_schedules"("id") ON DELETE SET NULL ON UPDATE CASCADE;
